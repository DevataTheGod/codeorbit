...
const SYSTEM_PROMPT = `You are a project planning expert for the CodeOrbit learning infrastructure platform. Your task is to analyze a student's project and create a structured learning roadmap with milestones and tasks.
