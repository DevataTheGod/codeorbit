# 💻 CodeOrbit — Local Setup Guide (LOCAL_SETUP.md)
...
Fill in the required variables (see [ENVIRONMENT_VARIABLES.md](file:///home/dev/Desktop/projects/codeorbit/docs/operations/ENVIRONMENT_VARIABLES.md)).
