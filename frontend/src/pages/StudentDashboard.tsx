        ...
        <header className="bg-card border-b border-border sticky top-0 z-50">
          <div className="container mx-auto px-4 h-16 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg overflow-hidden border border-primary/30 flex items-center justify-center bg-card">
      ...
      <Dialog open={mentorDialogOpen} onOpenChange={setMentorDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Reports generated by the CodeOrbit Chatbot.</DialogDescription>
          </DialogHeader>
