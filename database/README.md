...
- **[COMPLETE_DATABASE_SCHEMA.sql](file:///home/dev/Desktop/projects/Project-Skill/database/schema/COMPLETE_DATABASE_SCHEMA.sql):**
...
- **[SCHEMA_SQL_TO_EXECUTE.sql](file:///home/dev/Desktop/projects/Project-Skill/database/schema/SCHEMA_SQL_TO_EXECUTE.sql):**
...
- **[CREATE_USER_TRIGGER.sql](file:///home/dev/Desktop/projects/Project-Skill/database/setup/CREATE_USER_TRIGGER.sql):**
...
- **[FIX_DATABASE_SYNC.sql](file:///home/dev/Desktop/projects/Project-Skill/database/setup/FIX_DATABASE_SYNC.sql):**
  - *Purpose:* Fixes synchronization drift between tables and validates trigger functions.
- **[CREATE_MISSING_DASHBOARD_TABLES.sql](file:///home/dev/Desktop/projects/Project-Skill/database/setup/CREATE_MISSING_DASHBOARD_TABLES.sql):**
  - *Purpose:* Installs supplemental metrics tables used to track student dashboard progress logs.
- **[CREATE_MISSING_HELP_REQUESTS_TABLE.sql](file:///home/dev/Desktop/projects/Project-Skill/database/setup/CREATE_MISSING_HELP_REQUESTS_TABLE.sql):**
  - *Purpose:* Creates the student support messaging system table (`help_requests`).
- **[CREATE_OLD_CHAT_MESSAGES_TABLE.sql](file:///home/dev/Desktop/projects/Project-Skill/database/setup/CREATE_OLD_CHAT_MESSAGES_TABLE.sql):**
